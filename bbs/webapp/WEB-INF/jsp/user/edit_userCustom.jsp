...
function addRow(){ //读取最后一行的行号，存放在txtLastIndex文本框中 
	...
	//添加列内容 
	newColumn.innerHTML = "<input name='_itemValue' type='text' size='20' /><input type='hidden' name='itemKey' value=''>"; 
...
<TABLE class="t-table" cellSpacing="1" cellPadding="2" width="100%" border="0">
  ...
  <TR>
    ...
    <TD class="t-content" width="88%" colSpan="3">
	    <select id="chooseType" name="chooseType" onChange="selectType(this);" disabled="disabled">
