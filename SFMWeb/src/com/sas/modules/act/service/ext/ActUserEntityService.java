 ...
 * 
 */
package com.sas.modules.act.service.ext;
...
import com.sas.modules.act.utils.ActUtils;
import com.sas.modules.sys.entity.Role;
import com.sas.modules.sys.service.SystemService;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.sas.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.sas.modules.sys.entity.User(null, userId)))){
